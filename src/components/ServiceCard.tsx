...
export default function ServiceCard({
  ...
  return (
    <div className="bg-white hover:bg-[#F4207B] text-gray-800 hover:text-white rounded-[10px] p-6 shadow-lg transition-all duration-150 group cursor-pointer hover:-translate-y-[10px] w-[500px] h-[610px] flex flex-col items-center">
      {/* Icon Container */}
